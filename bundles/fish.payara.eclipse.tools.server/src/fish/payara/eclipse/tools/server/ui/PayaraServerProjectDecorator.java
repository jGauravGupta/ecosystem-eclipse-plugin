...
public class PayaraServerProjectDecorator extends LabelProvider implements ILabelDecorator {

	private static final String PLUGIN_ARTIFACT_ID = "<artifactId>payara-server-maven-plugin</artifactId>"; //$NON-NLS-1$
	private static final String POM_XML = "pom.xml"; //$NON-NLS-1$
	private static final String ICON_PATH = "icons/payara-blue.png"; //$NON-NLS-1$

	private final Image image;
	private final Map<IProject, CacheEntry> cache = new ConcurrentHashMap<>();

	public PayaraServerProjectDecorator() {
		ImageDescriptor imageDescriptor = AbstractUIPlugin.imageDescriptorFromPlugin(
				"fish.payara.eclipse.tools.server", ICON_PATH); //$NON-NLS-1$
